...
۴. **هیچ خدمتی را به‌زور انتخاب نکن.** اگر خدمتی که اول به ذهنت می‌آید با درد واقعی این کسب‌وکار جور نبود، خدمت مناسب‌تر را انتخاب کن و در reason بنویس چرا آن یکی جور نبود. تحمیل خدمت، شخصی‌سازی را از بین می‌برد.
۵. «${FLAGSHIP_SERVICE_ID}» (تولید محتوای هوشمند) تخصص ویژه‌ی مهدیار است؛ **اگر واقعاً با درد جور بود** به آن اولویت بده — ولی قاعده‌ی ۴ بر این هم حاکم است.
۶. اگر هیچ خدمتی واقعاً متناسب نبود، کم‌ترین‌بدترین را انتخاب کن ولی confidence را پایین بگذار.
۷. ممنوع: قیمت، تخفیف، تضمین نتیجه.${lessons}`;
